      ...
      return (
        <MDBNavbar color="indigo" dark expand="md">
          ...
          <MDBCollapse id="navbarCollapse3" isOpen={this.state.isOpen} navbar>
            ...
            <MDBNavbarNav right>
            <MDBNavItem>
                <MDBNavLink to="/transactionusers">Transaction</MDBNavLink>
              </MDBNavItem>
              ...
              <div style={{ color: "white", marginRight: 10, marginTop: 7, marginLeft: 20 }}>
                {
                  this.props.role
                    ?
              ...
              <Link to="/login">
                <div onClick={this.onBtnLogout} className="textLogout" style={{ marginTop: 7 }}>
                  <ExitToAppIcon />
                          Logout
                      </div>
              </Link>
